...
const alleggsrecipe = () => {
  ...
  const filteredArray = eggData.filter((item: any) =>
    ...
    <>
      <div className="lg:flex justify-around items-center h-[10dvh] poppins">
        <div className="text-2xl font-bold flex justify-center items-center ">
          ALl Egg Based Recipes
        </div>
        <div className="w-64 grid grid-cols-5 items-center rounded-lg bg-slate-100 ml-8 mt-5 lg:mt-0">
